...
var _user$project$BelowTheLine_Data$ticketCandidates = F2(
	function (division, candidates) {
		...
		var ticketGroups = A2(
			...
			stateCandidates);
		var candidatesTicket = function (candidates) {
			return A2(
				_elm_lang$core$Maybe$withDefault,
				'',
				A2(
...
var _user$project$BelowTheLine_Data$ballotCandidates = F2(
	function (division, candidates) {
		return A2(
			...
			function (candidate) {
				return _elm_lang$core$Native_Utils.eq(
					_user$project$BelowTheLine_Data$candidateDivision(candidate),
					division);
			},
			candidates);
	});
var _user$project$BelowTheLine_Data$Candidate = F5(
	function (a, b, c, d, e) {
		return {givenName: a, surname: b, party: c, house: d, ballot: e};
	});
var _user$project$BelowTheLine_Data$Ticket = F3(
	function (a, b, c) {
		return {ticket: a, party: b, candidates: c};
	});
...
var _user$project$BelowTheLine_Data$house = function (houseCode) {
	...
	switch (_p8) {
		...
		case 'S':
			return _elm_lang$core$Json_Decode$succeed(_user$project$BelowTheLine_Data$Upper);
		default:
			return _elm_lang$core$Json_Decode$fail(
				A2(_elm_lang$core$Basics_ops['++'], houseCode, ' is not a proper house code'));
	}
};
var _user$project$BelowTheLine_Data$divisions = function (candidates) {
	var divisions = A2(
		_elm_lang$core$List$map,
		_user$project$BelowTheLine_Data$candidateDivision,
		A2(
			_elm_lang$core$List$filter,
			function (candidate) {
				return _elm_lang$core$Native_Utils.eq(candidate.house, _user$project$BelowTheLine_Data$Upper);
			},
			candidates));
	return _elm_community$list_extra$List_Extra$dropDuplicates(
		_elm_lang$core$List$sort(divisions));
};
var _user$project$BelowTheLine_Data$LowerBallot = function (a) {
	return {ctor: 'LowerBallot', _0: a};
};
var _user$project$BelowTheLine_Data$lowerBallot = A3(
	_elm_lang$core$Json_Decode$object2,
	F2(
		function (division, ballotPosition) {
			return _user$project$BelowTheLine_Data$LowerBallot(
				{division: division, ballotPosition: ballotPosition});
		}),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'div_nm', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'ballot_position', _elm_lang$core$Json_Decode$int));
var _user$project$BelowTheLine_Data$UpperBallot = function (a) {
	return {ctor: 'UpperBallot', _0: a};
};
var _user$project$BelowTheLine_Data$upperBallot = A4(
	_elm_lang$core$Json_Decode$object3,
	F3(
		function (state, ticket, ballotPosition) {
			return _user$project$BelowTheLine_Data$UpperBallot(
				{state: state, ticket: ticket, ballotPosition: ballotPosition});
		}),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'state_ab', _elm_lang$core$Json_Decode$string),
...
var _user$project$BelowTheLine_Data$candidate = A6(
	_elm_lang$core$Json_Decode$object5,
	F5(
		function (givenName, surname, party, house, ballot) {
			return {givenName: givenName, surname: surname, party: party, house: house, ballot: ballot};
		}),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'ballot_given_nm', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'surname', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'party_ballot_nm', _elm_lang$core$Json_Decode$string),
	A2(
		_elm_lang$core$Json_Decode$andThen,
		A2(_elm_lang$core$Json_Decode_ops[':='], 'nom_ty', _elm_lang$core$Json_Decode$string),
		_user$project$BelowTheLine_Data$house),
	A2(
		_elm_lang$core$Json_Decode$andThen,
		A2(
			_elm_lang$core$Json_Decode$andThen,
			A2(_elm_lang$core$Json_Decode_ops[':='], 'nom_ty', _elm_lang$core$Json_Decode$string),
			_user$project$BelowTheLine_Data$house),
		_user$project$BelowTheLine_Data$ballot));
var _user$project$BelowTheLine_Data$candidates = _elm_lang$core$Json_Decode$list(_user$project$BelowTheLine_Data$candidate);
var _user$project$BelowTheLine_Data$fetchData = function (url) {
	return A2(_evancz$elm_http$Http$get, _user$project$BelowTheLine_Data$candidates, url);
};

var _user$project$BelowTheLine_BallotSelection$onChange = function (msg) {
	return A2(
		_elm_lang$html$Html_Events$on,
		'change',
		A2(
...
var _user$project$BelowTheLine_BallotSelection$ballotToggle = function (ballotView) {
	var _p0 = ballotView;
	if (_p0.ctor === 'OrderBallot') {
		return A2(
			_elm_lang$html$Html$button,
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Events$onClick(
					_user$project$BelowTheLine_BallotSelection$ChangeView(_user$project$BelowTheLine_BallotSelection$ViewBallot))
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html$text('View your ballot paper')
				]));
	} else {
		return A2(
			_elm_lang$html$Html$button,
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Events$onClick(
					_user$project$BelowTheLine_BallotSelection$ChangeView(_user$project$BelowTheLine_BallotSelection$OrderBallot))
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html$text('Change your preference order')
				]));
	}
};
var _user$project$BelowTheLine_BallotSelection$SelectDivision = function (a) {
	return {ctor: 'SelectDivision', _0: a};
};
var _user$project$BelowTheLine_BallotSelection$divisionSelect = F2(
	function (division, candidates) {
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_user$project$BelowTheLine_BallotSelection$onChange(_user$project$BelowTheLine_BallotSelection$SelectDivision)
				]),
			divisionOptions);
	});
var _user$project$BelowTheLine_BallotSelection$view = F3(
	function (division, ballotView, candidates) {
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('ballot-selection')
				]),
			_elm_lang$core$Native_List.fromArray(
				[
...
var _user$project$BelowTheLine_Splash$view = F3(
	function (division, candidates, error) {
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text('Prepare for your 2016 Australian Federal Election senate vote')
						])),
					function () {
					var _p0 = candidates;
					if (_p0.ctor === 'Just') {
						return A2(_user$project$BelowTheLine_BallotSelection$divisionSelect, division, _p0._0);
					} else {
						var _p1 = error;
						if (_p1.ctor === 'Just') {
							return A2(
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html$text('Oops, something has gone wrong. Try reloading the page')
									]));
						} else {
							return A2(
								_elm_lang$html$Html$p,
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html$text('Loading candidates')
									]));
						}
					}
				}()
...
var _user$project$BelowTheLine_OrderPreferences$icon = function (name) {
	return A2(
...
var _user$project$BelowTheLine_SenateBallot$candidateView = F2(
	function (candidate, number) {
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('ballot-candidate-group')
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					A2(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									...
									A2(
										_elm_lang$core$Maybe$withDefault,
										'',
										A2(_elm_lang$core$Maybe$map, _elm_lang$core$Basics$toString, number)))
								]))
						])),
					A2(
					_elm_lang$html$Html$div,
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$class('ballot-candidate')
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text(candidate.surname),
...
var _user$project$BelowTheLine_SenateBallot$belowTicketView = F2(
	function (order, ticket) {
		var number = function (candidate) {
			return A2(
				_elm_lang$core$Maybe$map,
				F2(
					function (x, y) {
		...
		var candidates = A2(
			...
			function (candidate) {
				return A2(
					_user$project$BelowTheLine_SenateBallot$candidateView,
					candidate,
					number(candidate));
			},
			ticket.candidates);
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('below-ballot-position')
				]),
			A2(
				_elm_lang$core$List_ops['::'],
				A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$class('party-title')
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text(party)
						])),
				candidates));
	});
...
var _user$project$BelowTheLine_SenateBallot$ballotView = F3(
	function (division, tickets, order) {
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('ballot-paper-sen'),
					_elm_lang$html$Html_Attributes$style(
					_elm_lang$core$Native_List.fromArray(
						[
							{
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$class('ballot-header')
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							A2(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Attributes$class('ballot-header-title'),
									_elm_lang$html$Html_Attributes$colspan(
									_elm_lang$core$List$length(tickets) + 1)
								]),
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html$text('Senate Ballot Paper'),
									A2(
									_elm_lang$html$Html$br,
									_elm_lang$core$Native_List.fromArray(
										[]),
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$class('ballot-space')
						]),
					_elm_lang$core$Native_List.fromArray(
						[])),
					A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$class('ballot-option-a')
						]),
					A2(
						_elm_lang$core$Basics_ops['++'],
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html_Attributes$class('option-a-header')
									]),
								_elm_lang$core$Native_List.fromArray(
									[
										A2(
										...
										_elm_lang$core$Native_List.fromArray(
											[
												_elm_lang$html$Html$text('You may'),
												A2(
												_elm_lang$html$Html$br,
												_elm_lang$core$Native_List.fromArray(
													[]),
												_elm_lang$core$Native_List.fromArray(
													[])),
												_elm_lang$html$Html$text('vote in one of'),
												A2(
												_elm_lang$html$Html$br,
												_elm_lang$core$Native_List.fromArray(
													[]),
												_elm_lang$core$Native_List.fromArray(
													[])),
												_elm_lang$html$Html$text('two ways')
											])),
										A2(
										_elm_lang$html$Html$p,
										_elm_lang$core$Native_List.fromArray(
											[
												_elm_lang$html$Html_Attributes$class('senate-option')
											]),
										_elm_lang$core$Native_List.fromArray(
											[
												_elm_lang$html$Html$text('Either')
											])),
										A2(
										_elm_lang$html$Html$h2,
										_elm_lang$core$Native_List.fromArray(
										...
										_elm_lang$core$Native_List.fromArray(
											[
												_elm_lang$html$Html$text('Above the line')
											])),
										A2(
										_elm_lang$html$Html$p,
										_elm_lang$core$Native_List.fromArray(
										...
										_elm_lang$core$Native_List.fromArray(
											[
												_elm_lang$html$Html$text('By numbering at least '),
												A2(
												_elm_lang$html$Html$strong,
												_elm_lang$core$Native_List.fromArray(
													[]),
												...
												_elm_lang$core$Native_List.fromArray(
													[])),
												_elm_lang$html$Html$text('of these boxes in the order'),
												A2(
												_elm_lang$html$Html$br,
												_elm_lang$core$Native_List.fromArray(
													[]),
												_elm_lang$core$Native_List.fromArray(
													[])),
												_elm_lang$html$Html$text('of your choice (with number'),
												A2(
												_elm_lang$html$Html$br,
												_elm_lang$core$Native_List.fromArray(
													[]),
												_elm_lang$core$Native_List.fromArray(
													[])),
												_elm_lang$html$Html$text('1 as your first choice)')
											]))
									]))
							]),
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$class('ballot-line')
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$class('ballot-option-b')
						]),
					A2(
						_elm_lang$core$Basics_ops['++'],
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html_Attributes$class('option-b-header')
									]),
								_elm_lang$core$Native_List.fromArray(
									[
										A2(
...
var _user$project$BelowTheLine$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _user$project$BelowTheLine$moveBack = F2(
	function (item, items) {
		var _p0 = A2(_elm_community$list_extra$List_Extra$elemIndex, item, items);
		if (_p0.ctor === 'Just') {
			var _p2 = _p0._0;
			var swap = function (_p1) {
				return A2(
					...
					_p2 + 1,
					A2(_elm_lang$core$List$take, _p2 + 2, _p1));
			}(items);
			var back = A2(_elm_lang$core$List$drop, _p2 + 2, items);
			var front = A2(_elm_lang$core$List$take, _p2, items);
			return A2(
				_elm_lang$core$Basics_ops['++'],
				front,
				A2(
...
var _user$project$BelowTheLine$moveFront = F2(
	function (item, items) {
		var _p3 = A2(_elm_community$list_extra$List_Extra$elemIndex, item, items);
		if (_p3.ctor === 'Just') {
			var _p5 = _p3._0;
			var swap = function (_p4) {
				return A2(
					_elm_lang$core$List$drop,
					_p5 - 1,
					A2(_elm_lang$core$List$take, _p5, _p4));
			}(items);
			var back = A2(_elm_lang$core$List$drop, _p5 + 1, items);
			var front = A2(_elm_lang$core$List$take, _p5 - 1, items);
			return A2(
				_elm_lang$core$Basics_ops['++'],
				front,
				A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[item]),
					A2(_elm_lang$core$Basics_ops['++'], swap, back)));
		} else {
			return items;
		}
	});
var _user$project$BelowTheLine$toggle = F2(
	function (item, items) {
			...
			switch (_p6.ctor) {
				case 'LoadCandidates':
					...
					return _elm_lang$core$Native_Utils.update(
						model,
						{
							candidates: _elm_lang$core$Maybe$Just(_p7),
							ballotCandidates: A2(
								_elm_lang$core$Maybe$map,
				...
				case 'BallotSelection':
					var _p8 = _p6._0;
					if (_p8.ctor === 'SelectDivision') {
						var _p9 = _p8._0;
						return _elm_lang$core$Native_Utils.update(
							model,
							{
								division: _elm_lang$core$Maybe$Just(_p9),
								ballotCandidates: A2(
									_elm_lang$core$Maybe$map,
									_user$project$BelowTheLine_Data$ballotCandidates(_p9),
									model.candidates),
					...
					switch (_p10.ctor) {
						case 'AddAll':
							return _elm_lang$core$Native_Utils.update(
								model,
								{
									preferences: A2(_user$project$BelowTheLine$union, _p10._0, model.preferences)
								});
						case 'RemoveAll':
							return _elm_lang$core$Native_Utils.update(
								model,
								{
									preferences: A2(_user$project$BelowTheLine$difference, _p10._0, model.preferences)
								});
						case 'TogglePreference':
							return _elm_lang$core$Native_Utils.update(
								model,
								{
									preferences: A2(_user$project$BelowTheLine$toggle, _p10._0, model.preferences)
								});
						case 'IncreasePreference':
							return _elm_lang$core$Native_Utils.update(
								model,
								{
									preferences: A2(_user$project$BelowTheLine$moveFront, _p10._0, model.preferences)
								});
						default:
							return _elm_lang$core$Native_Utils.update(
								model,
								{
									preferences: A2(_user$project$BelowTheLine$moveBack, _p10._0, model.preferences)
								});
					}
			}
		}();
...
var _user$project$BelowTheLine$urlParser = function (location) {
	var ballotViewFromString = function (string) {
		...
		switch (_p14) {
			case 'OrderBallot':
				return _elm_lang$core$Maybe$Just(_user$project$BelowTheLine_BallotSelection$OrderBallot);
			case 'ViewBallot':
				return _elm_lang$core$Maybe$Just(_user$project$BelowTheLine_BallotSelection$ViewBallot);
			default:
				return _elm_lang$core$Maybe$Nothing;
		}
	};
	...
	var params = A2(
		...
		A2(
			_elm_lang$core$String$split,
			'&',
			A2(_elm_lang$core$String$dropLeft, 1, location.search)));
	...
	var ballotView = A2(
		_elm_lang$core$Maybe$withDefault,
		_user$project$BelowTheLine_BallotSelection$OrderBallot,
		A3(
...
var _user$project$BelowTheLine$OrderPreferences = function (a) {
	return {ctor: 'OrderPreferences', _0: a};
};
...
var _user$project$BelowTheLine$ballotDisplay = F5(
	function (division, ballotView, candidates, tickets, preferences) {
		...
		var selection = A2(
			...
			A3(
				_user$project$BelowTheLine_BallotSelection$view,
				_elm_lang$core$Maybe$Just(division),
				ballotView,
				candidates));
		return A2(
...
var Elm = {};
Elm['BelowTheLine'] = Elm['BelowTheLine'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['BelowTheLine'], 'BelowTheLine', typeof _user$project$BelowTheLine$main === 'undefined' ? null : _user$project$BelowTheLine$main);
